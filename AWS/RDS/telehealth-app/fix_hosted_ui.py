...
# Update client to enable Hosted UI
try:
    ...
    print("✅ Client updated for Hosted UI")
    
    # Test the login URL
    print("🌐 Try this login URL:")
    print("https://us-east-2faeshksax.auth.us-east-2.amazoncognito.com/login?client_id=6kr0t8kp0bughr3s2ut0106mrk&response_type=code&scope=openid&redirect_uri=https://1fjxzto6nk.execute-api.us-east-1.amazonaws.com/prod/callback")
